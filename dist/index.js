...
async function loadYaml(file) {
  const content = await read_file_default(file);
  if (!parseYaml) {
    ({ __parsePrettierYamlConfig: parseYaml } = await import("./yaml-G4UI5PXV.js"));
  }
  try {
...
var stringReplaceAll2 = String.prototype.replaceAll ?? function(pattern, replacement) {
  if (pattern.global) {
    return this.replace(pattern, replacement);
  }
  return this.split(pattern).join(replacement);
...
function printDocToDebug(doc2) {
  ...
  function printDoc(doc3, index, parentParts) {
    ...
    if (doc3.type === DOC_TYPE_LINE2) {
      const withBreakParent = parentParts?.[index + 1]?.type === DOC_TYPE_BREAK_PARENT2;
      if (doc3.literal) {
    ...
    if (doc3.type === DOC_TYPE_BREAK_PARENT2) {
      const afterHardline = parentParts?.[index - 1]?.type === DOC_TYPE_LINE2 && parentParts[index - 1].hard;
...
function callPluginPrintFunction(path15, options8, printPath, args, embeds) {
  ...
  if (printer2.printComment && !printer2.willPrintOwnComments?.(path15, options8)) {
...
var estreePlugin = createParsersAndPrinters([
  {
    importPlugin: () => import("./estree-GMZWLRST.js"),
...
var { parsers, printers } = createParsersAndPrinters([
  {
    importPlugin: () => import("./acorn-S6F37COH.js"),
    parsers: ["acorn", "espree"]
  },
  {
    importPlugin: () => import("./angular-FXANY4QV.js"),
    parsers: [
      "__ng_action",
      "__ng_binding",
      "__ng_interpolation",
  ...
  {
    importPlugin: () => import("./babel-UH5SNF43.js"),
    parsers: [
      "babel",
      "babel-flow",
      "babel-ts",
  ...
  {
    importPlugin: () => import("./flow-5UEARPTN.js"),
    parsers: ["flow"]
  },
  {
    importPlugin: () => import("./glimmer-FFXIVP3J.js"),
    parsers: ["glimmer"],
    printers: ["glimmer"]
  },
  {
    importPlugin: () => import("./graphql-KBSVU3RP.js"),
    parsers: ["graphql"],
    printers: ["graphql"]
  },
  {
    importPlugin: () => import("./html-RXGVLJCK.js"),
    parsers: ["html", "angular", "vue", "lwc", "mjml"],
    printers: ["html"]
  },
  {
    importPlugin: () => import("./markdown-PHGVUSYR.js"),
    parsers: ["markdown", "mdx", "remark"],
    printers: ["mdast"]
  },
  {
    importPlugin: () => import("./meriyah-MIDW3AFY.js"),
    parsers: ["meriyah"]
  },
  {
    importPlugin: () => import("./postcss-F67QY5ZA.js"),
    parsers: ["css", "less", "scss"],
    printers: ["postcss"]
  },
  {
    importPlugin: () => import("./typescript-OM5TY63M.js"),
    parsers: ["typescript"]
  },
  {
    importPlugin: () => import("./yaml-G4UI5PXV.js"),
    parsers: ["yaml"],
    printers: ["yaml"]
  }
]);
...
function htmlVueSsrPrettier(config = {}) {
  return {
    ...
    async transformIndexHtml(html) {
      const page = index_exports.format(html, { ...config, parser: "html" });
      return page;
    }
  };
}
